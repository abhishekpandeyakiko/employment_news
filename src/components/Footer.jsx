      ...
      <div className="bg-primary-800 border-t border-primary-600">
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-24 py-2.5">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <nav className="flex flex-row flex-wrap gap-x-3 sm:gap-x-5 gap-y-2 text-[9px] sm:text-[10px] font-semibold uppercase tracking-wider text-white text-center md:text-left w-full md:w-auto overflow-hidden">
